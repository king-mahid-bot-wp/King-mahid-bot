...
module.exports = {
  ...
  event: async function ({ api, event }) {
    try {
      ...
      var texts = [
        "Mantion দিস না নয়ন বস এর মন ভালো নেই আজকে 💔🥀",
        ...
        "নয়ন বস এখন  বিজি জা বলার আমাকে বলতে পারেন_!!😼🥰",
        "এতো মিনশন নাহ দিয়া সিংগেল নয়ন রে একটা গফ দে 😒 😏",
        "Mantion_না দিয়ে সিরিয়াস প্রেম করতে চাইলে ইনবক্স",
        "মেনশন দিস না পারলে একটা গফ দে",
        "Mantion_দিস না বাঁলপাঁক্না নয়ন প্রচুর বিজি 🥵🥀🤐",
